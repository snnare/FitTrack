...
interface PantorrillaChartProps {
    metrics: Metrica[];
}

const PantorrillaChart: React.FC<PantorrillaChartProps> = ({ metrics }) => {

    const filteredMetrics = metrics.filter(
        m => m.pantorrilla !== undefined && m.pantorrilla !== null && !isNaN(m.pantorrilla)
    );
    ...
    const data = filteredMetrics.map(m => m.pantorrilla as number);
    ...
    return (
        <View style={styles.chartCard}>
            <Text style={styles.chartTitle}> Pantorrilla</Text>
            <LineChart
                data={{
...
export default PantorrillaChart;