...
interface CinturaChartProps {
    metrics: Metrica[];
}

const CinturaChart: React.FC<CinturaChartProps> = ({ metrics }) => {

    const filteredMetrics = metrics.filter(
        m => m.cintura !== undefined && m.cintura !== null && !isNaN(m.cintura)
    );
    ...
    const data = filteredMetrics.map(m => m.cintura as number);
