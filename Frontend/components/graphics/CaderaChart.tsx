...
interface CaderaChartProps {
    metrics: Metrica[];
}

const CaderaChart: React.FC<CaderaChartProps> = ({ metrics }) => {

    const filteredMetrics = metrics.filter(
        m => m.cadera !== undefined && m.cadera !== null && !isNaN(m.cadera)
    );
    ...
    const data = filteredMetrics.map(m => m.cadera as number);
    ...
    return (
        <View style={styles.chartCard}>
            <Text style={styles.chartTitle}> Evolución de cadera</Text>
            <LineChart
                data={{
