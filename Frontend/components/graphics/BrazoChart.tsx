...
interface brazoFlexionadoChartProps {
    metrics: Metrica[];
}

const BrazoChart: React.FC<brazoFlexionadoChartProps> = ({ metrics }) => {

    const filteredMetrics = metrics.filter(
        m => m.brazoFlexionado !== undefined && m.brazoFlexionado !== null && !isNaN(m.brazoFlexionado)
    );
    ...
    const data = filteredMetrics.map(m => m.brazoFlexionado as number);
    ...
    return (
        <View style={styles.chartCard}>
            <Text style={styles.chartTitle}> Brazo (bicep) </Text>
            <LineChart
                data={{
